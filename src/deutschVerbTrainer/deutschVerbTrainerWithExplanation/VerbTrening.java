...
class VerbTrening {
    ...
    public void startTrening() {
        ...
        while (true) {                                            // держит программу в работе, пока пользователь не выберет выход.
            System.out.println();
            System.out.println("Cделайте выбор:");
            System.out.println("1 - начать трренировку");
            System.out.println("2 - выйти");
            try {                                                  // обрабатывает возможные ошибки ввода (ввод не целого числа) и
                                                                   // очищает буфер сканера, чтобы избежать бесконечного цикла.
                ...
                switch (choice) {                                   // обрабатывает выбор пользователя, вызывая performExecise
                    case 1:
                        performExecise();
                        break;
                    case 2:
    ...
    public void performExecise() {                                   // Метод performExecise случайным образом выбирает глагол из списка и
                                                                     // предлагает пользователю спрягать его в формах Präteritum и Perfekt.
